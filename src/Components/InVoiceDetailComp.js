...
const InVoiceDetailComp = ({data, date, invoice, storeData}) => {
  return (
    <View style={styles.invoiceDetailMain}>
      ...
      <View style={styles.dateVoiceMain1}>
        <View>
          ...
          <Text style={styles.valueStyle}>{data?.[0]?.store_manager_name}</Text>
        </View>
        <View style={{alignItems: 'flex-end'}}>
          <Text style={styles.titleStyle1}>Store Name</Text>
          <Text style={styles.valueStyle}>{data?.[0]?.store_name}</Text>
        </View>
      </View>
      <View style={styles.dateVoiceMain1}>
        <View>
